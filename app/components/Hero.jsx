...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative flex flex-col lg:flex-row items-center justify-center gap-10 lg:justify-between px-6 lg:px-32 py-16 min-h-screen bg-gradient-to-b from-[#1D3557] to-[#1a2a40]">
      {/* Left Content */}
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8 }}
        className="text-center lg:text-left max-w-lg z-10"
      >
